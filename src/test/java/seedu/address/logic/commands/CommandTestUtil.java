...
public class CommandTestUtil {
    ...
    public static final String VALID_CULTURE_AMY = "Like German history.";
    public static final String VALID_CULTURE_BOB = "Favourite pastime: Eating pasta";
    public static final String VALID_TAG_HUSBAND = "husband";
    public static final String VALID_TAG_FRIEND = "friend";
    public static final String VALID_OFFSET_AMY = "+10:00";
    public static final String VALID_OFFSET_BOB = "-10:00";
    ...
    public static final String OFFSET_DESC_AMY = " " + PREFIX_GMT + VALID_OFFSET_AMY;
    public static final String OFFSET_DESC_BOB = " " + PREFIX_GMT + VALID_OFFSET_BOB;
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withTags(VALID_TAG_FRIEND).withOffset(VALID_OFFSET_AMY).build();
